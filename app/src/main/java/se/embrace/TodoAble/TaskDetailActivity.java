...
public class TaskDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (task != null) {
            ...
            //String myStarted = sdf.format(task.getStarted().getTime());
            TextView createdLabel = (TextView) findViewById(R.id.createdLabel);
            createdLabel.setText(task.getStarted().toString());
            //SimpleDateFormat sdf = new SimpleDateFormat("yyyy MM dd HH:mm");
            //String myStarted = sdf.format(task.getStarted());
        }
    ...
    private void saveOrCreateTask()
    {
        ...
        if (completed.isChecked())
        {
            ...
            // Set completedTime timestamp här?
